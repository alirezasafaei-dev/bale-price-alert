...
AUTH_INVALID_TOKEN = "احراز هویت نشد. لطفاً مجدداً از طریق بات تلگرام وارد شوید."
AUTH_ADMIN_TOKEN_MISSING = (
    "توکن مدیریت پیکربندی نشده است. لطفاً متغیر ADMIN_ACCESS_TOKEN را در تنظیمات سرور تنظیم کنید."
)
...
GENERIC_SERVICE_UNAVAILABLE = "سرویس موقتاً در دسترس نیست. لطفاً چند دقیقه دیگر تلاش کنید."
...
ASSET_PRICE_UNAVAILABLE = (
    "قیمت لحظه‌ای برای این دارایی در دسترس نیست. لطفاً چند دقیقه دیگر تلاش کنید."
)
...
PRICE_INGEST_ITEM_FAILED = "پردازش آیتم قیمت ناموفق بود. لطفاً فرمت داده را بررسی کنید."
PRICE_DATA_STALE = "داده‌های قیمت کهنه هستند. لطفاً صبر کنید تا قیمت‌ها به‌روز شوند."
PRICE_PROVIDER_ERROR = "خطا در دریافت قیمت از منبع. لطفاً چند دقیقه دیگر تلاش کنید."
...
INVALID_ASSET_CODE = "کد دارایی نامعتبر است. لطفاً از لیست دارایی‌های موجود انتخاب کنید."
PRICE_DATA_UNAVAILABLE = "دریافت قیمت برای این دارایی ممکن نیست. لطفاً بعداً تلاش کنید."
